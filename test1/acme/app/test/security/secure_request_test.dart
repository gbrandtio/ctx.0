...
import 'package:acme/security/crypto/ale_cipher.dart';
import 'package:acme/security/crypto/ctx_protocol.dart';
import 'package:acme/security/crypto/p256.dart';
import 'package:acme/security/crypto/request_signature.dart';
import 'package:acme/security/secure_request.dart';
...
void main() {
  ...
  test('a built secure request verifies and decrypts as the server would', () {
    ...
    final request = SecureRequestBuilder.build(
      ...
      ephemeralPrivate: P256.privateKeyFromScalar(b64(ale['ephemeralPrivateB64'] as String)),
    ...
    expect(request.headers[CtxProtocol.protocolHeader], equals(CtxProtocol.version));
    ...
    final envelope = AleEnvelope.fromJson(jsonDecode(utf8.decode(request.body)) as Map<String, dynamic>);

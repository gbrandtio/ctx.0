...
public sealed class AuthApiFactory : WebApplicationFactory<Program>
{
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureServices(services =>
        {
            var toRemove = services
                .Where(d => d.ServiceType == typeof(AcmeDbContext)
            ...
            services.AddDbContext<AcmeDbContext>((sp, options) =>
    ...
    public HttpClient CreateReadyClient()
    {
        ...
        scope.ServiceProvider.GetRequiredService<AcmeDbContext>().Database.EnsureCreated();
        return client;
    }
}

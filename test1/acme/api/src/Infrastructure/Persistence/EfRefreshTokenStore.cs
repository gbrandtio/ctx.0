...
/// <summary>EF Core-backed refresh token store over the app's <see cref="AcmeDbContext"/>.</summary>
public sealed class EfRefreshTokenStore(AcmeDbContext db) : IRefreshTokenStore
{

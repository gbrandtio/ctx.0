...
| [architecture/core.md](architecture/core.md) | `@ctx0/core` — the CLI-free composition engine. All scaffolding logic |
...
| [architecture/cli.md](architecture/cli.md) | `ctx0` — the command-line frontend, a client of the contract |
...
the costs it carries. The eight recorded so far cover the CLI/engine boundary, the transport
and contract, the templates-as-data model, the vendored security plane, deterministic
ordering, the localization model, and the workspace manifest.

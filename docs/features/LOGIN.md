...
- Google Sign-In button per Google branding (asset: `mobile-template/docs/brand-kit/google_logo.svg`).
...
- **Branding**: <logo/illustration from `mobile-template/docs/brand-kit/`, copy/tone>

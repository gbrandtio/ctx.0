...
The profile feature is shipped by the mobile template's profile module plus the app shell's settings/GDPR surface (`mobile-template/docs/APP_SHELL.md`). Fill in the product slots.
...
- **Password change**: dedicated flow requiring the old password; revokes all sessions (see `api-template/docs/security/audits/SECURITY_HARDENING_CHECKLIST.md` §9).

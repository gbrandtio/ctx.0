...
Located at `lib/core/models/cache_entry.dart`.
Stores:
...
Located at `lib/data/services/storage/hive_cache_service.dart`.
...
Located at `lib/data/services/api/interceptors/caching_client.dart`.

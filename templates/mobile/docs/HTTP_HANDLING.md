...
- **Implementation**: `AleClient` and `SecurityMetadataService` in the `ctx0_mobile_security` package.
- **Behavior**:
...
- **Implementation**: `SecureDeviceSigningClient` in the `ctx0_mobile_security` package.

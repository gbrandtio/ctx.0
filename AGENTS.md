...
| Enabling/disabling scaffoldable mobile features (Google Maps, Firebase push, Stripe checkout, profile/settings tabs, Google or email/password sign-in) | [`mobile-template/docs/INTEGRATIONS.md`](mobile-template/docs/INTEGRATIONS.md) — scaffolder-only; API-side counterparts per `api-template/AGENTS.md` |
